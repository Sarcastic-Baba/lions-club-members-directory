...
const members = [
    { name: 'Rajesh Kumar', club_name: 'Lions Club Patna Central', designation: 'President', location: 'Patna', profession: 'Advocate', specialty: 'Criminal Law', phone: '+91-9876543210', email: 'rajesh.kumar@lions321c1.org', address: '12, Gandhi Maidan Road, Patna, Bihar', year_of_joining: 2010, role: 'district_admin', status: 'active', show_phone: true, show_email: false },
    { name: 'Sunita Sharma', club_name: 'Lions Club Gaya', designation: 'Secretary', location: 'Gaya', profession: 'Doctor', specialty: 'General Medicine', phone: '+91-9876543211', email: 'sunita.sharma@lions321c1.org', address: '45, Medical College Road, Gaya, Bihar', year_of_joining: 2012, role: 'club_admin', status: 'active', show_phone: true, show_email: false },
